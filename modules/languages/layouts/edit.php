	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-header">
				<h4 class="card-title"><?php print Translator::do('EDIT_LANGUAGE'); ?></h4>
			</div>
			<div class="card-body">
				<form action="languages/change" method="post" class="form-horizontal">
					...
					<fieldset>
						...
						<div class="form-group">
							<label class="col-md-3 control-label"><?php print Translator::do('ISO_639_1'); ?></label>
					...
					<div class="form-group row">
						<div class="col-md-push-3 col-md-9">
							...
							<a href="languages" class="btn btn-secondary"><?php print Translator::do('CANCEL'); ?></a>
							<?php if ($state->canDelete) { ?>
								<a href="languages/delete/<?php print $state->languageId; ?>" class="btn btn-link confirm-delete float-right text-danger"><?php print Translator::do('DELETE'); ?></a>
							<?php } ?>
						</div>
					</div>
				</form>
